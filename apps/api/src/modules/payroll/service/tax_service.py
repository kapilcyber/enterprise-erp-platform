"""TaxConfiguration application service."""
...
class TaxConfigurationService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> PayTaxConfiguration:
        row = self._repo.get(ctx, row_id)
        if row is None:
            raise NotFoundException("TaxConfiguration not found")
        return row
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        self._audit.log_entity_change(
            ...
            entity_name="pay_tax_configuration",
            entity_id=row.id,
            operation="create",
