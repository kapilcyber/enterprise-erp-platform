"""WorkflowVersion lifecycle engine — draft / publish / retire / immutability."""
...
class WorkflowVersionEngine:
    ...
    def assert_executable(self, row) -> None:
        """Runtime may only execute Published versions (no draft execution)."""
        from modules.bpm.domain.exceptions import DraftVersionNotExecutable
