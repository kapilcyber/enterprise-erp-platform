"""StatusHistoryService application service."""
...
from modules.project.service.engines import ProjectStatusHistoryEngine
...
class StatusHistoryService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> PrjProjectStatusHistory:
        row = self._repo.get(ctx, row_id)
        if row is None:
            raise NotFoundException("StatusHistoryService not found")
        return row
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        self._audit.log_entity_change(
            ...
            entity_name="prj_project_status_history",
            entity_id=row.id,
            operation="create",
