...
from modules.integration.repository.notification_repository import NotificationRepository
from modules.integration.service.engines import NotificationEngine
...
class NotificationService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> IntNotification:
