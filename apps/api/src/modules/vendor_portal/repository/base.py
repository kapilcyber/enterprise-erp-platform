"""Vendor Portal scoped repository base."""
...
class VendorPortalScopedRepository(OrgScopedRepository):
    def __init__(self, db: Session) -> None:
        super().__init__(db)

    @staticmethod
    def apply_vp_filter(stmt, model, ctx: TenantContext, *, branch_scoped: bool = False):
        stmt = VendorPortalScopedRepository.apply_tenant_filter(stmt, model, ctx)
