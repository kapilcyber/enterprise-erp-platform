...
from modules.vendor_portal.domain.enums import CODE_PREFIXES, VendorPortalEntityType
...
class CodeSequenceRepository:
    ...
    def next_code(self, entity: VendorPortalEntityType, company_id: UUID, model, code_column: str) -> str:  # noqa: E501
