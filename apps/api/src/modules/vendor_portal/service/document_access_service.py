...
from modules.vendor_portal.repository.document_access_repository import DocumentAccessRepository
from modules.vendor_portal.service.engines import DocumentAccessEngine
...
class DocumentAccessService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> VpDocumentAccess:
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        doc = self._numbers.generate(
            VendorPortalEntityType.DOCUMENT_ACCESS,
            cid,
            VpDocumentAccess,
            "access_number",
        )
