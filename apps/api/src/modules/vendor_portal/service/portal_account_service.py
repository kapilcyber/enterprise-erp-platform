...
from modules.vendor_portal.repository.portal_account_repository import PortalAccountRepository
from modules.vendor_portal.service.engines import PortalAccountEngine
...
class PortalAccountService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> VpPortalAccount:
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        doc = self._numbers.generate(
            VendorPortalEntityType.PORTAL_ACCOUNT,
            cid,
            VpPortalAccount,
            "account_number",
        )
