...
from modules.vendor_portal.repository.dashboard_repository import DashboardRepository
from modules.vendor_portal.service.engines import DashboardEngine
...
class DashboardService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> VpDashboard:
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        doc = self._numbers.generate(
            VendorPortalEntityType.DASHBOARD,
            cid,
            VpDashboard,
            "dashboard_number",
        )
