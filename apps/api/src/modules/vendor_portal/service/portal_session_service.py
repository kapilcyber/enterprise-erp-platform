...
from modules.vendor_portal.repository.portal_session_repository import PortalSessionRepository
from modules.vendor_portal.service.engines import PortalSessionEngine
...
class PortalSessionService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> VpPortalSession:
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        doc = self._numbers.generate(
            VendorPortalEntityType.PORTAL_SESSION,
            cid,
            VpPortalSession,
            "session_number",
        )
