...
from modules.vendor_portal.repository.dashboard_widget_repository import DashboardWidgetRepository
from modules.vendor_portal.service.engines import DashboardWidgetEngine
...
class DashboardWidgetService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> VpDashboardWidget:
