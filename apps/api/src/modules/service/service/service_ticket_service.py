...
class ServiceTicketService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> SvcServiceTicket:
        row = self._repo.get(ctx, row_id)
        if row is None:
            raise NotFoundException("ServiceTicketService not found")
        return row
    ...
    def create(self, ctx: TenantContext, *, branch_id: UUID, company_id: UUID | None = None, **fields):
        ...
        doc = self._numbers.generate(SvcEntityType.TICKET, cid, SvcServiceTicket, "document_number")
