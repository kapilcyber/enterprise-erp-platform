"""Asset AstAssetServiceHistory repository."""
...
class AssetServiceHistoryRepository(AstScopedRepository):
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> AstAssetServiceHistory | None:
        stmt = select(AstAssetServiceHistory).where(AstAssetServiceHistory.id == row_id, AstAssetServiceHistory.is_deleted.is_(False))
    ...
    def list_rows(self, ctx: TenantContext, company_id: UUID):
        stmt = select(AstAssetServiceHistory).where(
            AstAssetServiceHistory.company_id == company_id,
    ...
    def update(self, ctx: TenantContext, row_id: UUID, **fields) -> AstAssetServiceHistory | None:
