"""ServiceHistoryService application service."""
...
from modules.asset.repository.asset_service_history_repository import AssetServiceHistoryRepository
...
class ServiceHistoryService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> AstAssetServiceHistory:
        ...
        if row is None:
            raise NotFoundException("ServiceHistoryService not found")
        return row
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        self._audit.log_entity_change(
            ...
            entity_name="ast_asset_service_history",
            entity_id=row.id,
            operation="create",
