...
from modules.ecommerce.repository.notification_repository import NotificationRepository
from modules.ecommerce.service.ecommerce_scope_validator import EcommerceScopeValidator
from modules.ecommerce.service.engines import NotificationEngine
...
class NotificationService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> EcNotification:
