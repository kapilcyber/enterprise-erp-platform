"""ReferenceCheck application service."""
...
class ReferenceCheckService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> RecReferenceCheck:
        row = self._repo.get(ctx, row_id)
        if row is None:
            raise NotFoundException("ReferenceCheck not found")
        return row
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        self._audit.log_entity_change(
            ...
            entity_name="rec_reference_check",
            entity_id=row.id,
            operation="create",
