"""CandidateDocument application service."""
...
class CandidateDocumentService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> RecCandidateDocument:
        row = self._repo.get(ctx, row_id)
        if row is None:
            raise NotFoundException("CandidateDocument not found")
        return row
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        self._audit.log_entity_change(
            ...
            entity_name="rec_candidate_document",
            entity_id=row.id,
            operation="create",
