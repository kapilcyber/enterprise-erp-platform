"""Seed Low-Code Phase 4 publish / runtime / preview permissions."""
...
revision: str = "0519_seed_lowcode_phase4_permissions"
down_revision: str | None = "0518_lc_preview_session"
...
PHASE4_PERMS = {
    ...
    "lowcode.runtime_submission:create",
    "lowcode.runtime_submission:update",
    "lowcode.preview_session:read",
    "lowcode.preview_session:create",
    "lowcode.preview_session:close",
    "lowcode.preview_session:expire",
}
