"""Seed Low-Code Phase 2C data source / expression permissions."""
...
revision: str = "0508_seed_lowcode_phase2c_permissions"
down_revision: str | None = "0507_lc_form_field_data_source_ref"
...
PHASE2C_PERMS = {
    ...
    "lowcode.data_source:create",
    "lowcode.data_source:update",
    ...
    "lowcode.expression:create",
    "lowcode.expression:update",
    "lowcode.expression:archive",
    "lowcode.expression:restore",
    "lowcode.expression:publish",
    "lowcode.expression:retire",
    "lowcode.expression_binding:read",
    "lowcode.expression_binding:create",
    "lowcode.expression_binding:update",
    "lowcode.expression_binding:delete",
}
