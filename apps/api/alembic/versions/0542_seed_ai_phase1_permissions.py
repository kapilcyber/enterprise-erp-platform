"""Seed AI Platform permissions and roles per FRD-27 Phase 1."""
...
revision: str = "0542_seed_ai_phase1_permissions"
down_revision: str | None = "0541_ai_cache_entry"
...
ROLE_SPECS: list[tuple[str, str, list[str]]] = [
    ("AI_PLATFORM_ADMIN", "AI Platform Admin", AI_PLATFORM_ADMIN_PERMISSIONS),
    ("AI_PROMPT_ENGINEER", "AI Prompt Engineer", AI_PROMPT_ENGINEER_PERMISSIONS),
    ("AI_PUBLISHER", "AI Publisher", AI_PUBLISHER_PERMISSIONS),
    ("AI_OPERATOR", "AI Operator", AI_OPERATOR_PERMISSIONS),
    ("AI_AUDITOR", "AI Auditor", AI_AUDITOR_PERMISSIONS),
    ("AI_CONSUMER", "AI Consumer", AI_CONSUMER_PERMISSIONS),
]
...
def upgrade() -> None:
    ...
    for code, resource, action, module in AI_PERMISSIONS:
