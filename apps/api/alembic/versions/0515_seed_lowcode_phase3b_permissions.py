"""Seed Low-Code Phase 3B page permissions."""
...
revision: str = "0515_seed_lowcode_phase3b_permissions"
down_revision: str | None = "0514_lc_page_region"
...
PHASE3B_PERMS = {
    ...
    "lowcode.page_version:create",
    "lowcode.page_version:update",
    "lowcode.page_version:publish",
    "lowcode.page_version:retire",
    "lowcode.page_version:clone",
    "lowcode.page_region:read",
    "lowcode.page_region:create",
    "lowcode.page_region:update",
    "lowcode.page_region:delete",
}
