"""Seed inventory workflow definitions per ERD_07 §14."""
...
revision: str = "0094_seed_inv_workflows"
down_revision: str | None = "0093_seed_inv_permissions"
...
WORKFLOWS: list[tuple[str, str, str, list[tuple[int, str, str, str]]]] = [
    (
        ...
        "inv_transfer_header",
        [
            (1, "WAREHOUSE_MANAGER", "Warehouse Manager Approval", "role"),
        ],
    ),
    (
        ...
        [
            (1, "WAREHOUSE_MANAGER", "Warehouse Manager Review", "role"),
            (2, "INVENTORY_CONTROLLER", "Inventory Controller / Finance Review", "role"),
        ],
    ),
    (
        "INV_CYCLE_COUNT_APPROVAL",
        "Cycle Count Variance Approval",
        "inv_cycle_count_header",
        [
            (1, "WAREHOUSE_MANAGER", "Warehouse Manager Approval", "role"),
        ],
    ),
            ...
            if exists:
                ...
                conn.execute(
                    sa.text(
                        ...
                        VALUES (:id, :tid, :code, :name, 'inventory', :doc, 1, true, :now, :now)
                        """
                    ),
                    {
                        "id": wf_id,
