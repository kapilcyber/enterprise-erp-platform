"""Seed Developer Portal Phase 3 permissions and refresh role grants."""
...
from modules.devportal.permissions import (  # noqa: E402
...
revision: str = "0579_seed_devportal_phase3_permissions"
down_revision: str | None = "0578_dp_tryit_session"
...
ROLE_SPECS: list[tuple[str, str, list[str]]] = [
    ("DEVPORTAL_ADMIN", "Developer Portal Admin", DEVPORTAL_ADMIN_PERMISSIONS),
    ("API_PRODUCT_MANAGER", "API Product Manager", API_PRODUCT_MANAGER_PERMISSIONS),
    ("DEVELOPER", "Developer", DEVELOPER_PERMISSIONS),
    ("PARTNER_DEVELOPER", "Partner Developer", PARTNER_DEVELOPER_PERMISSIONS),
    ("API_AUDITOR", "API Auditor", API_AUDITOR_PERMISSIONS),
]
...
def upgrade() -> None:
    ...
    for code, resource, action, module in DEVPORTAL_PHASE3_PERMISSIONS:
...
def downgrade() -> None:
    conn = op.get_bind()
    for code, *_ in DEVPORTAL_PHASE3_PERMISSIONS:
        conn.execute(
