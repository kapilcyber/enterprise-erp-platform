"""Seed AI Platform Phase 4 evaluation/feedback/multimodal permissions."""
...
revision: str = "0558_seed_ai_phase4_permissions"
down_revision: str | None = "0557_ai_multimodal_profile"
...
ROLE_SPECS: list[tuple[str, str, list[str]]] = [
    ("AI_QUALITY_ANALYST", "AI Quality Analyst", AI_QUALITY_ANALYST_PERMISSIONS),
]
...
def upgrade() -> None:
    ...
    for code, resource, action, module in AI_PHASE4_PERMISSIONS:
...
def downgrade() -> None:
    ...
    for code, *_ in AI_PHASE4_PERMISSIONS:
        conn.execute(
