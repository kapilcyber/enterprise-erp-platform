"""Seed Low-Code Phase 3A event handler / localization permissions."""
...
revision: str = "0511_seed_lowcode_phase3a_permissions"
down_revision: str | None = "0510_lc_localization_entry"
...
PHASE3A_PERMS = {
    ...
    "lowcode.event_handler:create",
    "lowcode.event_handler:update",
    "lowcode.event_handler:delete",
    "lowcode.localization:read",
    "lowcode.localization:create",
    "lowcode.localization:update",
    "lowcode.localization:delete",
    "lowcode.localization:publish",
    "lowcode.localization:retire",
}
