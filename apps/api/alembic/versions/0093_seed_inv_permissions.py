"""Seed inventory permissions and roles."""
...
revision: str = "0093_seed_inv_permissions"
down_revision: str | None = "0092_inv_reorder_policy"
...
ROLE_SPECS: list[tuple[str, str, list[str]]] = [
    ("WAREHOUSE_EXECUTIVE", "Warehouse Executive", WAREHOUSE_EXECUTIVE_PERMISSIONS),
    ("WAREHOUSE_MANAGER", "Warehouse Manager", WAREHOUSE_MANAGER_PERMISSIONS),
    ("INVENTORY_CONTROLLER", "Inventory Controller", INVENTORY_CONTROLLER_PERMISSIONS),
]
...
def upgrade() -> None:
    ...
    for code, resource, action, module in INV_PERMISSIONS:
...
def downgrade() -> None:
    ...
    perm_codes = [p[0] for p in INV_PERMISSIONS]
