"""Seed Developer Portal Phase 4 permissions and refresh role grants."""
...
revision: str = "0581_seed_devportal_phase4_permissions"
down_revision: str | None = "0580_dp_portal_report"
...
def upgrade() -> None:
    ...
    for code, resource, action, module in DEVPORTAL_PHASE4_PERMISSIONS:
...
def downgrade() -> None:
    conn = op.get_bind()
    for code, *_ in DEVPORTAL_PHASE4_PERMISSIONS:
        conn.execute(
