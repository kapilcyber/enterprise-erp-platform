"""Seed BPM Phase 3B trigger and notification template permissions."""
...
revision: str = "0485_seed_bpm_phase3b_permissions"
down_revision: str | None = "0484_bpm_notification_template"
