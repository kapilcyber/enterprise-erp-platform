"""Seed finance workflow definitions."""
...
revision: str = "0038_seed_finance_workflows"
down_revision: str | None = "0037_seed_finance_permissions"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

WORKFLOWS: list[tuple[str, str, str, list[tuple[int, str, str, str]]]] = [
    (
        "FIN_JOURNAL_APPROVAL",
        "Journal Entry Approval",
        "fin_journal_header",
        [(1, "FINANCE_MANAGER", "Finance Manager Review", "role")],
    ),
    (
        "FIN_VENDOR_PAYMENT",
        ...
        "fin_vendor_ledger",
        [
            (1, "FINANCE_EXEC", "Finance Executive", "role"),
            (2, "FINANCE_MANAGER", "Finance Manager", "role"),
            (3, "CFO", "CFO Approval", "role"),
        ],
    ),
    (
        "FIN_ASSET_POSTING",
        "Asset Transaction Posting",
            ...
            if exists:
                ...
                conn.execute(
                    sa.text(
                        ...
                        VALUES (:id, :tid, :code, :name, 'finance', :doc, 1, true, :now, :now)
                        """
                    ),
                    {
                        "id": wf_id,
