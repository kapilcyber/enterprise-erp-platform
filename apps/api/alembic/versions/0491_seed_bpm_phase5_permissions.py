"""Seed BPM Phase 5 simulation permissions."""
...
revision: str = "0491_seed_bpm_phase5_permissions"
down_revision: str | None = "0490_bpm_simulation_run"
