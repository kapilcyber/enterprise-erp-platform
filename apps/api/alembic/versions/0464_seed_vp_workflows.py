"""Seed Vendor Portal workflow definitions per ERD_24."""
...
revision: str = "0464_seed_vp_workflows"
down_revision: str | None = "0463_seed_vp_permissions"
...
WORKFLOWS: list[tuple[str, str, str, list[tuple[int, str, str, str]]]] = [
    (
        "VP_ACCOUNT_APPROVAL",
        "Vendor Portal Account Approval",
        "vp_portal_account",
        [
            (1, "SUPPLIER_USER", "Supplier User Submit", "role"),
            (2, "PROCUREMENT_MANAGER", "Procurement Manager Approval", "role"),
            (3, "VENDOR_PORTAL_ADMIN", "Vendor Portal Admin Approval", "role"),
        ],
    ),
    (
        "VP_QUOTE_SUBMISSION",
    ...
    (
        ...
        [
            (1, "SUPPLIER_USER", "Supplier User Submit", "role"),
            (2, "PROCUREMENT_MANAGER", "Procurement Manager Review", "role"),
        ],
    ),
    (
        "VP_INVOICE_SUBMISSION",
    ...
    (
        ...
        [
            (1, "SUPPLIER_USER", "Supplier User Submit", "role"),
            (2, "PROCUREMENT_MANAGER", "Procurement Manager Approval", "role"),
            (3, "QUALITY_COORDINATOR", "Quality Coordinator Review", "role"),
            (4, "VENDOR_PORTAL_ADMIN", "Vendor Portal Admin Approval", "role"),
        ],
    ),
]
            ...
            if exists:
                ...
                conn.execute(
                    sa.text(
                        ...
                        VALUES (:id, :tid, :code, :name, 'vendor_portal', :doc, 1, true, :now, :now)
                        """
                    ),
                    {
                        "id": wf_id,
