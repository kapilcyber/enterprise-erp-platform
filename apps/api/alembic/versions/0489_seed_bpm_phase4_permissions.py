"""Seed BPM Phase 4 runtime permissions."""
...
revision: str = "0489_seed_bpm_phase4_permissions"
down_revision: str | None = "0488_bpm_history_delegation"
