"""Seed manufacturing permissions and roles."""
...
revision: str = "0113_seed_mfg_permissions"
down_revision: str | None = "0112_mfg_variance"
...
ROLE_SPECS: list[tuple[str, str, list[str]]] = [
    ("SHOP_FLOOR_OPERATOR", "Shop Floor Operator", SHOP_FLOOR_OPERATOR_PERMISSIONS),
    ("PRODUCTION_ENGINEER", "Production Engineer", PRODUCTION_ENGINEER_PERMISSIONS),
    ("PRODUCTION_SUPERVISOR", "Production Supervisor", PRODUCTION_SUPERVISOR_PERMISSIONS),
    ("PRODUCTION_MANAGER", "Production Manager", PRODUCTION_MANAGER_PERMISSIONS),
]
...
def upgrade() -> None:
    ...
    for code, resource, action, module in MFG_PERMISSIONS:
...
def downgrade() -> None:
    ...
    perm_codes = [p[0] for p in MFG_PERMISSIONS]
