"""Seed Low-Code Phase 2A section/field permissions."""
...
revision: str = "0499_seed_lowcode_phase2a_permissions"
down_revision: str | None = "0498_lc_form_field"
...
PHASE2A_PERMS = {
    ...
    "lowcode.section:create",
    "lowcode.section:update",
    "lowcode.section:delete",
    "lowcode.field:read",
    "lowcode.field:create",
    "lowcode.field:update",
    "lowcode.field:delete",
