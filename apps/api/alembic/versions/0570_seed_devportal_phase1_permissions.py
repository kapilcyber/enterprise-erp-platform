"""Seed Developer Portal permissions and roles per FRD-28 Phase 1."""
...
revision: str = "0570_seed_devportal_phase1_permissions"
down_revision: str | None = "0569_dp_api_product_environment"
...
def upgrade() -> None:
    ...
    for code, resource, action, module in DEVPORTAL_PERMISSIONS:
...
def downgrade() -> None:
    ...
    for code, *_ in DEVPORTAL_PERMISSIONS:
        conn.execute(
