"""Seed BPM permissions and roles per FRD-25 Phase 1."""
...
revision: str = "0470_seed_bpm_permissions"
down_revision: str | None = "0469_bpm_workflow_version"
