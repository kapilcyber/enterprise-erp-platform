"""Seed BPM Phase 2A designer permissions."""
...
revision: str = "0474_seed_bpm_phase2a_permissions"
down_revision: str | None = "0473_bpm_designer_transition"
