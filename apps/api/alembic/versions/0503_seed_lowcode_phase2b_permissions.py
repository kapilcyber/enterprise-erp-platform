"""Seed Low-Code Phase 2B component permissions."""
...
revision: str = "0503_seed_lowcode_phase2b_permissions"
down_revision: str | None = "0502_lc_form_field_component_version_ref"
...
PHASE2B_PERMS = {
    ...
    "lowcode.component:create",
    "lowcode.component:update",
    "lowcode.component:archive",
    "lowcode.component:restore",
    "lowcode.component_version:read",
    "lowcode.component_version:create",
    "lowcode.component_version:update",
    "lowcode.component_version:publish",
    "lowcode.component_version:retire",
    "lowcode.component_version:clone",
}
