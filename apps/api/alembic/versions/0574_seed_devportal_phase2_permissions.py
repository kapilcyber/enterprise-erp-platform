"""Seed Developer Portal Phase 2 permissions and refresh role grants."""
...
revision: str = "0574_seed_devportal_phase2_permissions"
down_revision: str | None = "0573_dp_entitlement"
...
def upgrade() -> None:
    ...
    for code, resource, action, module in DEVPORTAL_PHASE2_PERMISSIONS:
...
def downgrade() -> None:
    conn = op.get_bind()
    for code, *_ in DEVPORTAL_PHASE2_PERMISSIONS:
        conn.execute(
